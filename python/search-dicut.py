...
for i in range(NUM_ITER):
    ...
    model_engine = experiments.piecewise_linear_model(control_points, lo = -2, hi = 2)
...
experiments.fine_check(inst, model_engine, grid_size=EVAL_GRID_SIZE, grid_depth=EVAL_GRID_DETPH,\
                       verbose=EVAL_VERBOSE, simple=False,\
                       discr=1000000, lo = LO, hi = HI,
